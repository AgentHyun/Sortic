...
public interface UserMapper {
    ...
    /** ✅ userId로 사용자 조회 (전체 유저 정보)*/
    @Select("SELECT user_id AS userId, password, store_name AS storeName, email, phone, grade, region, profile_image AS profileImage FROM Users WHERE user_id = #{userId}")
